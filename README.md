...
Satirical press-release generator (StupidAPIs) — output is fabricated parody for entertainment, never a real company announcement. Keyless. Renamed on the gateway to `corporate-satire` / `corporate_satire_generate` on 2026-09-21; the URL below still resolves to it.
...
`tools/list` at `https://gateway.pipeworx.io/press-release/mcp` returns the tools in the table
